...
The Bitwarden and CloakBrowser plugins are installed into `/a0/usr` during the image build. Existing deployments with old persisted `/a0/usr` volumes should reset those volumes when adopting this image.
