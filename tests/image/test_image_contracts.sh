...
run_bash_in_image 'grep -q "Ghostship CloakBrowser humanize patch" /a0/plugins/_browser/helpers/runtime.py'
run_bash_in_image 'grep -q "launch_persistent_context_async" /a0/plugins/_browser/helpers/runtime.py'
run_bash_in_image 'grep -q "\"humanize\": True" /a0/plugins/_browser/helpers/runtime.py'
run_bash_in_image '! grep -q "ensure_playwright_binary" /a0/plugins/_browser/helpers/runtime.py'
